...
const tableDropSQL = [
  ...
  'DROP TABLE IF EXISTS supervisor_evaluation_items;',
  'DROP TABLE IF EXISTS intern_evaluation_items;',
  'DROP TABLE IF EXISTS intern_documents;',
  'DROP TABLE IF EXISTS intern_daily_logs;',
  'DROP TABLE IF EXISTS supervisor_evaluations;',
  'DROP TABLE IF EXISTS intern_evaluations;',
  'DROP TABLE IF EXISTS hte_evaluations;',
...
async function cleanupAndSetupDatabase() {
  try {
