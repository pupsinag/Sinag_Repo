...
sequelize
  ...
  .then(() => {
    ...
    // Skip sync() due to existing tablespace issues - using migrations instead
    console.log('⏭️  Skipping auto-sync (using migrations)');
...
process.on('uncaughtException', (error) => {
  ...
  // Log but continue - do NOT exit process
});
