...
// INTERN – download/view own document by document type
router.get('/intern-docs/download/own/:docColumn', authMiddleware(['intern']), internDocsController.downloadOwnInternDoc);

// ADVISER/COORDINATOR/ADMIN – download/view any intern's document
router.get('/intern-docs/download/:internId/:documentType', authMiddleware(['adviser', 'coordinator', 'superadmin']), internDocsController.downloadInternDoc);

// INTERN – download / view document (for interns viewing own documents)
...
// Upload / update MOA (Company/Supervisor can upload)
router.put('/company/moa', authMiddleware(['company', 'supervisor']), handleMOAUploadError, companyDashboardController.uploadMoa);

// View / download MOA (Intern or Company/Supervisor)
router.get('/company/moa', authMiddleware(['intern', 'company', 'supervisor']), companyDashboardController.getMoa);

// View MOA for specific company (Coordinator/Adviser/SuperAdmin)
router.get('/company/moa/:companyId', authMiddleware(['coordinator', 'adviser', 'superadmin']), companyDashboardController.getMoaByCompanyId);
